...
namespace Org.OpenAPITools.Model
{
    ...
    /// WellHeader
    /// </summary>
    [DataContract(Name = "WellHeader")]
    public partial class WellHeader : IEquatable<WellHeader>, IValidatableObject
    {
        /// <summary>
        /// Defines Type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WellHeader" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected WellHeader() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="WellHeader" /> class.
        /// </summary>
        ...
        public WellHeader(Guid xid = default(Guid), string uwi = default(string), string name = default(string), string group = default(string), string field = default(string), string route = default(string), TypeEnum type = default(TypeEnum), FluidEnum fluid = default(FluidEnum), LiftTypeEnum liftType = default(LiftTypeEnum), double lat = default(double), double lon = default(double), int version = default(int))
        {
            ...
            this.Name = name ?? throw new ArgumentNullException("name is a required property for WellHeader and cannot be null");
            // to ensure "group" is required (not null)
            this.Group = group ?? throw new ArgumentNullException("group is a required property for WellHeader and cannot be null");
            // to ensure "field" is required (not null)
            this.Field = field ?? throw new ArgumentNullException("field is a required property for WellHeader and cannot be null");
            // to ensure "route" is required (not null)
            this.Route = route ?? throw new ArgumentNullException("route is a required property for WellHeader and cannot be null");
            this.Type = type;
            this.Fluid = fluid;
        ...
        {
            return this.Equals(input as WellHeader);
        }

        /// <summary>
        /// Returns true if WellHeader instances are equal
        /// </summary>
        /// <param name="input">Instance of WellHeader to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WellHeader input)
        {
            if (input == null)
                return false;
