...
class WellHeader(ModelNormal):
    ...
    allowed_values = {
        ...
        ('lift_type',): {
            ...
            'GAS_LIFT': "GAS_LIFT",
            'ELECTRIC_SUBMERSIBLE_PUMP': "ELECTRIC_SUBMERSIBLE_PUMP",
            'ROD_LIFT': "ROD_LIFT",
            'PLUNGER': "PLUNGER",
        },
    }
    ...
    @convert_js_args_to_python_args
    def __init__(self, uwi, name, group, field, route, type, fluid, lift_type, lat, lon, version, *args, **kwargs):  # noqa: E501
        """WellHeader - a model defined in OpenAPI
